              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="animate-in fade-in slide-in-from-left-4 duration-600">
                  ...
                  <div className="space-y-6 text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                    <p>
                      In Florida, the average auto policy payout is $10,000.
                      With traditional methods, after a 33% attorney contingency
                      fee, victims are left with less than $7,000 before
                      additional processing costs.
                    </p>
                    <p>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-600">
                ...
                <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                  Join thousands of accident victims who have already saved
                  money with our transparent, flat-rate pricing. Start your
                  claim today for just $500.
                </p>
                ...
                <div className="mt-8 p-4 bg-white/10 rounded-lg">
                  <div className="flex items-center justify-center gap-2 text-blue-100">
                    ...
                    <span className="font-semibold">
                      Average client saves $2,800+ compared to traditional
                      attorney fees
                    </span>
                  </div>
                </div>
