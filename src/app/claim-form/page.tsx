                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-green-50 dark:bg-green-950/30 rounded-lg p-4 mb-4">
                      <p className="text-sm text-green-800 dark:text-green-200 mb-4">
                        ...
                        the release of your complete insurance claim information
                        related to the accident. This includes claim status
                        updates, settlement offers, correspondence, and any
                        other information related to your claim processing.
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        >
                          ...
                          including, but not limited to, claim status,
                          settlement offers, correspondence, and all
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        >
                          <strong>
                            Disclose my insurance claim information EXCEPT for
                            the following:
                          </strong>
                        </label>
                      </div>
                        ...
                        <div className="ml-7 space-y-3">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <label
                              ...
                              className="text-sm text-gray-700 dark:text-gray-300"
                            >
                              Detailed financial information beyond claim
                              amounts
                            </label>
                          </div>
                        </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                      <p className="text-sm text-yellow-800 dark:text-yellow-200">
                        ...
                        person(s)/organization(s) listed above may not be
                        covered by state/federal rules governing privacy and
                        security of data and may be permitted to further share
                      ...
                      <div className="bg-green-50 dark:bg-green-950/30 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="group">
                            ...
                            <Input
                              value={
                                formData.insuranceAuthRevocationOrganization
                              }
                              onChange={(e) =>
                                handleInputChange(
                                  "insuranceAuthRevocationOrganization",
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          In the event that my information has already been
                          shared by the time my authorization is revoked, it may
                          be too late to cancel permission to share my insurance
                          information.
                        </p>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          ...
                          permission for the information detailed in Section II
                          to be shared with the person(s) or organization(s)
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          ...
                          authorization or the cancellation of this
                          authorization will not prevent me from receiving any
                          treatment or benefits I am entitled to receive,
                          provided this information is not required to determine
                          if I am eligible to receive those treatments or
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-6">
                      <p className="text-sm text-green-800 dark:text-green-200">
                        ...
                        you have read, understood, and agree to all terms of
                        this authorization.
                      </p>
                    </div>
                    ...
                    <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 bg-gray-50 dark:bg-gray-800/50">
                      <div className="text-center mb-4">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                          ...
                          and understood this insurance information disclosure
                        ...
                        <div className="ml-7 space-y-3">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <label
                              ...
                              className="text-sm text-gray-700 dark:text-gray-300"
                            >
                              Communicable diseases including, but not limited
                              to, HIV and AIDS
                            </label>
                          </div>
                          <div className="flex items-center gap-3">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3">
                          <input
                            ...
                            value="hardCopy"
                            checked={
                              formData.hipaaDisclosureForm === "hardCopy"
                            }
                            onChange={(e) =>
                              handleInputChange(
                                "hipaaDisclosureForm",
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4 mb-4">
                      <p className="text-sm text-blue-800 dark:text-blue-200">
                        ...
                        ClaimSaver+. However, any information already disclosed
                        cannot be retrieved.
                      </p>
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4 mb-4">
                      <p className="text-sm text-blue-800 dark:text-blue-200">
                        ...
                        disclosure of your health information as described
                        above.
                      </p>
                    </div>
