...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-between py-8 px-4 sm:px-8 pt-24">
          ...
          <Card className="shadow-lg border-blue-100 dark:border-blue-900 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
            ...
            <CardContent>
              <p className="text-gray-600 dark:text-gray-300">
                ...
                accident details, personal info, and securely upload supporting
                documents for a streamlined, efficient process.
              </p>
            </CardContent>
          </Card>
          <Card className="shadow-lg border-blue-100 dark:border-blue-900 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
            ...
            <CardContent>
              <p className="text-gray-600 dark:text-gray-300">
                ...
                intelligent algorithms pair you with legal experts tailored to
                your unique case needs.
              </p>
            </CardContent>
          </Card>
          <Card className="shadow-lg border-blue-100 dark:border-blue-900 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl">
            <Card className="shadow-lg border-blue-100 dark:border-blue-900 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  Receive notifications on new developments, hearing dates, and
            ...
            <Card className="shadow-lg border-blue-100 dark:border-blue-900 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-300">
                  Our network of attorneys works to negotiate fair compensation
